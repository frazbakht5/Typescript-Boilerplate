...
async function Authorization(req: Request, res: Response, next: NextFunction): Promise<Response<any, Record<string, any>> | undefined> {
  ...
  req.setState({ userTokenData: token?.data })
  next()
}
